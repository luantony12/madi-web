<footer>
  <div class="footer-grid">
    ...
    <div class="footer-col">
      <h4>Servicios</h4>
      <ul>
        <li><a href="#servicios">Construcción Residencial</a></li>
        <li><a href="#servicios">Edificios Comerciales</a></li>
        <li><a href="#servicios">Obras Industriales</a></li>
        <li><a href="#servicios">Remodelaciones</a></li>
        <li><a href="#servicios">Gerencia de Proyectos</a></li>
      </ul>
    </div>
